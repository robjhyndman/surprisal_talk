...
\AtBeginSection[]{
   \begin{frame}{Outline}\vspace*{0.3cm}
...
\begin{textblock}{8.7}(0.5,0)\usebeamerfont{title}
{\color{$titlecolor$}\raggedright\par\inserttitle}
\end{textblock}
\begin{textblock}{8.7}(0.5,6.6)
{\color{$titlecolor$}\raggedright{\insertauthor}\mbox{}\\[0.1cm]
\insertdate\\[0.1cm]
\texttt{\footnotesize\href{https://robjhyndman.com/ihaka2026}{robjhyndman.com/ihaka2026}}}
\end{textblock}}
